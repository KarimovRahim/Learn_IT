    ...
    <div className="pt-20">
      <Section className="bg-gradient-to-b from-white to-gray-100 dark:from-zinc-950 dark:to-zinc-900">
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="text-xl text-black/70 mb-8 dark:text-zinc-400">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {allCourses.map((course) => (
            ...
            >
              ...
              <div className="mb-6">
                <h4 className="text-black font-medium mb-3 dark:text-white">Что вы изучите:</h4>
                <ul className="space-y-2">
                  {course.features.slice(0, 4).map((feature, idx) => (
                    <li key={idx} className="flex items-center gap-2 text-sm text-black/70 dark:text-zinc-400">
        ...
        <div className="text-center mt-16">
          <h2 className="text-2xl font-bold text-black mb-6 dark:text-white">Не нашли подходящий курс?</h2>
