      ...
      <AnimatePresence>
        {isOpen && (
          <>
            ...
            {/* Меню с правильным позиционированием */}
            <motion.div
              initial={{ x: '100%' }}
              animate={{ x: 0 }}
              exit={{ x: '100%' }}
              transition={{ type: 'spring', damping: 25, stiffness: 200 }}
              className="fixed top-0 right-0 h-full w-[280px] bg-zinc-900 shadow-2xl z-50 md:hidden overflow-y-auto"
            >
              {/* Шапка с логотипом */}
              <div className="sticky top-0 bg-zinc-900/95 backdrop-blur-sm border-b border-zinc-800 p-5">
